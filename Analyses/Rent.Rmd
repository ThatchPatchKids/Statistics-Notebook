...
hist(Rent$Price, xlab = "Price of Rent", main = "Rent Histogram")
...
This histogram shows a normal distribution with one extreme outlier in the 1600-1700 range.
...
The mean appears to be larger than the median which could suggest that their could be some outliers to the right of the histogram.


## Conclusion

Rent ranges from 800-1800.
